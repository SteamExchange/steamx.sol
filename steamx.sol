...
Y88b.         888     888             d88P888 88888b.d88888   Y88o88P   
 "Y888b.      888     8888888        d88P 888 888Y88888P888    Y888P    
    "Y88b.    888     888           d88P  888 888 Y888P 888    d888b    
...
contract SteamExchange is Context, IERC20, Ownable {
    ...
    address public _researchWallet;
    address public _operationsWallet;
    address public _infrastructureWallet;
    ...
    constructor () {
        ...
        _researchWallet = msg.sender;
        _operationsWallet = msg.sender;
        _infrastructureWallet = msg.sender;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        payable(_rfiWallet).transfer(newBalance);
    ...
    function setresearchWallet(address _address) public onlyOwner() {
    ...
    function setinfrastructureWallet(address _address) public onlyOwner() {
    ...
    function setrfiWallet(address _address) public onlyOwner() {
        _rfiWallet = _address;
    }
